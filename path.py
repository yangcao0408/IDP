...
def leave(pid, start_flag, entrance_flag, collec_flag):
    ...
    if pid.sensor_values() == [1, 1, 1, 1] and start_flag == True:
        pid.turn_right()
        entrance_flag = True
        while pid.sensor_values() == [1, 1, 1, 1]:
            pass

    if pid.sensor_values() == [1, 1, 1, 1] and entrance_flag == True:
        pid.turn_right()
        collec_flag = True
        while pid.sensor_values() == [1, 1, 1, 1]:
            pass
...
def path1(pid, collec_flag):
    ...
    if pid.sensor_values() == [1, 1, 0, 0] and collec_flag == True:
        flag1 = True
...
def path2(pid, collec_flag):
    ...
    if pid.sensor_values() == [0, 0, 1, 1] and flag1 == True:
        flag2 = True
        while pid.sensor_values() == [0, 0, 1, 1]:
            pass
...
def path3(pid, collec_flag):
    ...
    if pid.sensor_values() == [0, 0, 1, 1] and flag3 == True:
        # Go straight to collection
        while pid.sensor_values() == [0, 0, 1, 1]:
            pass
...
def path4(pid, collec_flag):
    ...
    if pid.sensor_values() == [1, 1, 0, 0] and flag4 == True:
        pid.deposit_box()
        flag1 = 0
        flag2 = 0
        flag3 = 0
    ...
    if pid.sensor_values() == [0, 0, 1, 1] and flag4 == True:
        # Go straight to collection
        while pid.sensor_values() == [0, 0, 1, 1]:
            pass
